...
export {
  ...
  type SpaghettiEngineChangeCursor,
  type SpaghettiEngineChangeReplayOptions,
  type SpaghettiEngineDurableChange,
  type SpaghettiEngineChangeReplay,
