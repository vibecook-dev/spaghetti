...
pub use facts::{
    ...
    EffectiveStateDimension, EffectiveStateEvidenceKind, EffectiveStateQualifiedValue,
    EffectiveStateRevisionFact, EffectiveStateValueAuthority, EffectiveStateValueProvenance,
    EntityKey, EvidenceKind, EvidenceStrength, Fact, FactBatch, FactEnvelope, FactId,
    FactProvenance, FactSemanticContext, FactSemanticRevision, HookEventSummary,
