...
use crate::adapter::{
    ...
    RunEvidenceFact, RunFact, ScopeProgramManifest, SessionFact, SourceAccess, SourceInstance,
    SourceInstanceKey, SourceInstanceSpec, SourceObjectDescriptor, SourceRoot, SourceSnapshot,
