...
export function SettingsDialog({ open, onOpenChange, onRebuild, rebuilding, engine, stats }: SettingsDialogProps) {
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-50 bg-[#11100f]/72 backdrop-blur-[3px]" />
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex w-[min(32rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col border border-[#2b2623]/60 bg-[#f8f6f0] text-[#2b2623] shadow-2xl outline-none dark:border-[#d4cbbd]/45 dark:bg-[#171615] dark:text-[#d4cbbd]">
          <header className="flex items-center justify-between border-b border-[#2b2623]/20 px-5 py-3 dark:border-[#d4cbbd]/20">
