...
Workflows, session-index metadata, and project memory are now implemented in
adjacent Phase 5 packs. Tool-result, settings, and other reviewed sidecar packs
