...
| Wave 2 | in progress: **L5 adapters** (`land/l5-adapters`, owns the last clippy warnings), **L6 surface** (`land/l6-surface`: delete native.ts mirror, collapse Engine* DTOs, parser→generated-type tests, re-gate skipping suite), **L7 perf** (`land/l7-perf`: durable ingest throughput vs 08-15's 9.5k rec/s, then the §6 report), **L8 docs** (`land/l8-docs`: trim 012B/C/D to ≤300 lines, archive program docs, README/CHANGELOG 0.8.0, Chopsticks + VibeField integration notes). Done: L1c `df5a459`, L1d `2f83d8b`, L4b `a36454f`, playground tests in CI `5c16423`, L0 hygiene `d8e1033`, observer clippy-clean `6d91eef` | Rust crate 315,610 → **149,896** LOC; SDK 81,349 → 61,977; ratchet 4/19/17; Rust 646/646, SDK 399/0, CLI 117/0, playground 35/0, validate-all 9/9 |
| Wave 3 | not started | — |
