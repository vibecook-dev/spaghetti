...
| Wave 2 | in progress: **L5 adapters** (`land/l5-adapters`, emit the 8 missing families + decode perf + relation set + Grok exact usage + promotion), **L0 hygiene** (`land/l0-hygiene`, zero clippy warnings in source/engine/core/napi; CI `clippy -D warnings` green once L5 cleans adapter/), **L4b** (`land/l4b-playground-catalog`, playground library onto the catalog path), **L1c** (`land/l1c-scope-tests`, harden two load-sensitive observer tests); L6/L7/L8 not started | Wave 1 complete 2026-08-23 12:22: Rust crate 315,610 → 153,324 LOC, SDK 81,349 → 61,977; ratchet baseline 4/24/17 |
| Wave 3 | not started | — |
