...
File-history/artifacts, workflows, session-index metadata, project memory, and
persisted tool results are now implemented in adjacent Phase 5 packs. Settings
and other remaining sources still need reviewed semantics. The observation
